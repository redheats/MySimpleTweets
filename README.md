...
**
Simple Tweeter** is an android app that allows a user to view his Twitter timeline and post a new tweet. The app utilizes [Twitter REST API](https://developer.twitter.com/en/docs/api-reference-index).
...
-[Link to Video Walkthrough](https://www.dropbox.com/s/sxzdk5b6j4x6nmf/tweets.mp4?dl=0)



## Notes
using the Twitter API was a bit more challenging htis time , i had to get my head around the db , more updates comming soon and a better UI 
...
## License
    ...
    Copyright [2018] [Lorgensky Pelicier]
